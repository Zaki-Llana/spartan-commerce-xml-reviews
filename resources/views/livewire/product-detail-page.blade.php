        ...
        <div class="w-full px-4 md:w-1/2 ">
          <div class="lg:pl-20">
            ...
            <div class="flex items-center space-x-2 mt-4">
              <span class="text-yellow-500 flex space-x-1">
                @for ($i = 1; $i <= 5; $i++)
                  <svg wire:click="rate({{ $i }})" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 cursor-pointer {{ $product->rating >= $i ? 'fill-current' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 15l-3.09 1.635L7.64 12.6 5 9.72l3.91-.24L10 3l1.09 6.48 3.91.24-2.64 2.88 1.73 4.035z"/>
                  </svg>
                @endfor
              </span>
              <span class="text-gray-700 dark:text-gray-400">{{ $product->rating }} out of 5 stars</span>
            </div>
